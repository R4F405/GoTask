...
/**
 * Controlador para la vista de visualización de una tarea en un grupo.
 */
public class VerTareaGrupoController implements Initializable {
    ...
    /**
     * Inicializa la vista y muestra los detalles de la tarea en el grupo.
     *
